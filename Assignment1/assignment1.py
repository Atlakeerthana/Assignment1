...
#code by ATLA KEERTHANA
#27/05/2021
#Triangle ABC for Q.NO 2.5
...
def find_sides(angle_A,angle_B,side_a):
    angle_C=180-(angle_A+angle_B)
    b=(math.sin((angle_B*math.pi)/180))/math.sin((angle_A*math.pi)/180)*side_a
    c=(math.sin((angle_C*math.pi)/180))/math.sin((angle_A*math.pi)/180)*side_a
    return b,c
    side_a,angle_A,angle_B=list(map(int,input("Enter a side and angles A,B values:").split()))
    print(side_a,angle_A,angle_B)
    b,c=find_sides(angle_A,angle_B,side)
    print('two sides are...b:{} and c:{}'.format(b,c))
