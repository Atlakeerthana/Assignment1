...
\begin{lstlisting}
https://github.com/ATLA KEERTHANA/Matrix-Theory/tree/main/Assignment1/Codes
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/ATLA KEERTHANA/Matrix-Theory/tree/main/Assignment1
\end{lstlisting}
%
...
\\
\frac{sin (90+15)^{\degree}}{7}=\frac{sin 45^{\degree}}{b}
\\
\frac{cos 90^{\degree}}{7}=\frac{sin 45^{\degree}}{b}
\\
...
\\
\frac{sin (90+15)^{\degree}}{7}=\frac{sin 30^{\degree}}{c}
\\
\frac{cos 15^{\degree}}{7}=\frac{sin 30^{\degree}}{c}
\\
\frac{\sqrt{3}+1}{14\cdot\sqrt{2}}=\frac{1}{c\cdot2}
\\
c=\frac{7\cdot\sqrt{2}}{\sqrt{3}+1}
\\
c=3.62
\end{align}
Now, vertices of given $\triangle ABC$ can be written as,
\begin{align}
\vec{A}=\myvec{0\\c}=\myvec{0\\3.62}, \vec{B}=\myvec{0\\0}, \vec{c}=\myvec{a\\0}=\myvec{7\\0}
\end{align}
\\
